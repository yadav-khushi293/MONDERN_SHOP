...
export const Footers = () => {
  return `
      <footer>
        <div class="Aparent1">
            <div class="pchild_1" id="box1">
                <h3>About Us</h3>
                <div class="ul">
                    <ul class="ui_1">
                        <li class="list_1">About Organization</li>
                        <li class="list_1" >Our Clients</li>
                        <li class="list_1">Our Partners</li>
                    </ul>
                </div>
            </div>

            <div class="pchild_1" id="box2">
                <h3>Achievements</h3>
        ...
        <div class="Bparent2">
            <div class="pchild_1" id="box3">
                <h3>Quick Links</h3>
                <div class="ul">
                    <ul class="ui_1">
                        <li class="list_1"><a href="#">Introduction</a></li>
                        <li class="list_1"><a href="#">Organization Team</a></li>
                        <li class="list_1"><a href="#">Press Enquiries</a></li>
                    </ul>
                </div>
            </div>
            <div class="pchild_1" id="box4">
        ...
        <div class="Cparent3">
            <div class="pchild_1" id="box5">
                <h3>Important Links</h3>
                <div class="ul">
                    <ul class="ui_1">
                        <li class="list_1"><a href="#">Privacy Policy</a></li>
                        <li class="list_1"><a href="#">Cookies Policy</a></li>
                        <li class="list_1"><a href="#">Terms & Conditions</a></li>
                    </ul>
                </div>
            </div>
            <div class="pchild_1" id="box6">
